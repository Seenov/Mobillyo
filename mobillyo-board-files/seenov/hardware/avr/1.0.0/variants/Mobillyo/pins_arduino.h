...
//  tx and rx leds are same pin change feb 10, 2017 Mobillyo
#define TX_RX_LED_INIT	DDRC |= (1<<7); DDRE |= (1<<2)
#define TXLED0			PORTE |= (1<<2)
#define TXLED1			PORTE &= ~(1<<2)
#define RXLED0			PORTE |= (1<<2)
#define RXLED1			PORTE &= ~(1<<2)
